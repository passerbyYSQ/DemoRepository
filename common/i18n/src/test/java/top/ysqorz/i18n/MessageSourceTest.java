...
import top.ysqorz.i18n.message.loader.ClassPathI18nResourceLoader;
...
public class MessageSourceTest {
    private ClassPathI18nResourceLoader resourceLoader;
    private LocaleContextResolver localeContextResolver;

    @Before
    public void init() throws IOException {
        resourceLoader = new ClassPathI18nResourceLoader();
...
//    }
    ...
    @Test
    public void testOREMessageSource() throws Exception {
