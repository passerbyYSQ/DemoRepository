...
import top.ysqorz.migration.export.SimpleExportWorker;
...
//        Thread.sleep(10000);
        SimpleExportWorker exportWorker = SimpleExportWorker.builder()
        ...
        SimpleDataCollector dataCollector = new SimpleDataCollector(exportWorker, backupWorker);
